...
→ Weiter zu: [Prinzipien](/framework/principles/overview)
...
→ Weiter zu: [Domänen](/framework/architecture/domains)
...
→ Weiter zu: [Reifegradmodell](/framework/maturity-model/model)
...
→ Weiter zu: [Artefakte](/framework/artifacts/overview)
...
→ Weiter zu: [Referenz für klinische Systemkonstellationen](/framework/architecture/reference-clinical-system-constellations)